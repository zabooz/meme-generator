const memeCon = document.querySelector('.meme');
const jokeCon = document.querySelector('.joke');
const quoteCon = document.querySelector('.quote');
...
function showMeme() {
  // Value is a string representing image UR  
...
function showQuote() {
  ...
  clearAll();
  quoteCon.appendChild(newQuoteText);
  quoteCon.appendChild(newQuoteAuthor);
}
...
function showRiddle() {
  ...
  riddleCon.appendChild(newRiddleText);
  riddleCon.appendChild(newRiddleAnswer);
...
const answer = riddleCon.querySelector('#riddleAnswer');

if(riddle && answer.hidden){
  return answer.hidden = false;
